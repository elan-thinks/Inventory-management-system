...
/// <summary>
/// Customer list layout — full controls on the design surface (drag/drop).
/// </summary>
partial class CustomerListForm
{
    ...
    private void InitializeComponent()
    {
        ...
        lblStatus.Location = new Point(260, 6);
        ...
        cboStatus.Location = new Point(260, 24);
        ...
        btnClearFilters.Location = new Point(412, 22);
        ...
        grid.Columns[2].HeaderText = "Phone";

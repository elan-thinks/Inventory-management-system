...
- ReportViewerForm (SCR-017) displays the result in a DataGridView and offers Print.
...
- **Stock-In / Stock-Out** — SELECT from InventoryTransaction WHERE TransactionType and date range.

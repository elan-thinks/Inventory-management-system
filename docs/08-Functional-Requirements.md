...
## 8.5 Customer Management (FR-CUS)
...
## 8.8 Inventory Adjustment (FR-ADJ)
...
## 8.9 Stock Status & Monitoring (FR-STK)
...
## 8.10 Searching & Filtering (FR-SRCH)
...
## 8.14 Delegation Authorization Model
